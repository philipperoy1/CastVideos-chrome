...
CastPlayer.prototype.initializeCastPlayer = function () {
  ...
  options.receiverApplicationId = "AAF1BC92";
...
CastPlayer.prototype.requestTextTrackToggle = function () {
  let castSession =
    cast.framework.CastContext.getInstance().getCurrentSession();
  let media = castSession.getMediaSession();
  var activeTrackIds;
  if (media.activeTrackIds.length) {
    activeTrackIds = [];
    document.getElementById("texttrack_toggle").style.opacity = 0.4;
  } else {
    activeTrackIds = [2];
    document.getElementById("texttrack_toggle").style.opacity = 1;
  }
  // var activeTrackIds = [];
  ...
  media.editTracksInfo(
    tracksInfoRequest,
    () => {
      console.log("SUCCCCCCCESSSSSSSSS !");
    },
    () => {
      console.log("ERRRRRRRRRRRORRRRRRRRRRRRR !");
    }
  );
};
...
CastPlayer.prototype.initializeUI = function () {
  ...
  document
    .getElementById("texttrack_toggle")
    .addEventListener("click", this.requestTextTrackToggle.bind(this));
